...
#SBATCH --job-name=vim-t-imagenet-non-merge          # 作业名称
#SBATCH --account=PAS2490		    # Project ID
#SBATCH --output=/users/PAS2490/marcusshen/Vim/output_logs_vim/vim-t-imagenet-non-merge.log         # 输出日志文件
#SBATCH --error=/users/PAS2490/marcusshen/Vim/output_logs_vim/vim-t-imagenet-non-merge_error.log           # 错误日志文件
#SBATCH --nodes=1                   # 节点数
