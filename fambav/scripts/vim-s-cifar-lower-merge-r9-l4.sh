...
#SBATCH --job-name=vim-s-cifar-lower-merge-r9-l4          # 作业名称
#SBATCH --account=PAS2490		    # Project ID
#SBATCH --output=/users/PAS2490/marcusshen/Vim/output_logs_vim/vim-s-cifar-lower-merge-r9-l4.log         # 输出日志文件
#SBATCH --error=/users/PAS2490/marcusshen/Vim/output_logs_vim/vim-s-cifar-lower-merge-r9-l4_error.log           # 错误日志文件
#SBATCH --nodes=1                   # 节点数
